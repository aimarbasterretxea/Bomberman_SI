...
public class Menua extends JFrame implements Observer {
 ...
 private JButton etsaia1;
 private JButton etsaia2;
 ...
 public Menua() {
  ...
  etsaia1 = new JButton("");
  etsaia1.setToolTipText("Etsai_1: Etsai honek arruntak izango dira");
  etsaia1.setIcon(new ImageIcon(Menua.class.getResource("/irudiak/doria2.png")));
  etsaia1.setForeground(SystemColor.control);
  etsaia1.setBorderPainted(false);
  etsaia1.setBackground(SystemColor.control);
  etsaia1.setBounds(229, 340, 65, 63);
  etsaia1.addActionListener(getKontroladorea());
  contentPane.add(etsaia1);
  
  etsaia2 = new JButton("");
  etsaia2.setToolTipText("Etsai_2: Etsai honek inteligenteak izango dira\r\n");
  etsaia2.setIcon(new ImageIcon(Menua.class.getResource("/irudiak/baloon1.png")));
  etsaia2.setForeground(SystemColor.control);
  etsaia2.setBorderPainted(false);
  etsaia2.setBackground(SystemColor.control);
  etsaia2.setBounds(342, 340, 65, 63);
  etsaia2.addActionListener(getKontroladorea());
  contentPane.add(etsaia2);
 ...
 private class Kontroladorea extends Observable implements ActionListener, ItemListener, KeyListener {
     ...
     public void actionPerformed(ActionEvent e) {
         ...
         if(jatorria == etsaia1) {
          etsaia1.setBackground(new Color(204, 204, 204));
          etsaia1.setBounds(229, 337, 65, 63);
         ...
         if(jatorria == etsaia2) {
          etsaia2.setBackground(new Color(204, 204, 204));
          etsaia2.setBounds(342, 337, 65, 63);
